...
**An example usage commands are included for the following Python scripts:** *wsal_automated_quality_check_script.py*, *wsal_machine_learning_script.py*, *wsal_preprocess_sim_run_into_csv_files.py*, *wsal_wasserstein_distance_event_ids.py*. Use the Python *--help* option to check descriptions.